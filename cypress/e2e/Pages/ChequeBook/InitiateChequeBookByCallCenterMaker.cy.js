export class InitiateChequeBookCallCenter {
    ...
    searchAccoutNumberClick() {
        ...
        // cy.get('#DynamicModalCloseBtn').click().then(($el) => {
        //     if ($el.length > 0) {
        //       // Perform actions when the locator is found

        //     } else {
        //       // Skip the locator and continue with the test
        //       cy.get(this.getserarchAccountNumberEl).click();
        //     }
        //   });
    ...
    selectBranch() {
        ...
        cy.get(this.getSelectBranchEl)
            .select('Gulshan Branch', { force: true });
    ...
    saveAndSubmitButton() {
        ...
        cy.get('.offset-4 > .btn-success').click();
